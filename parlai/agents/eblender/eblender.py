...
class EblenderAgent(TransformerGeneratorAgent):
    ...
    def compute_loss(self, batch, return_output=False):
        ...
        # inverse_target = [(1/tar_tok) for tar_tok in target_list]
        # inverse_sum = sum(inverse_target)
        # additional_loss_per_pred_tok = empathy_loss / inverse_sum


        # token_and_empathy_loss = [(oloss + additional_loss_per_pred_tok) for oloss in loss.tolist()]
        # additional_loss = torch.FloatTensor(token_and_empathy_loss)

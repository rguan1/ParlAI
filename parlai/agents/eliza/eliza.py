...
class FakeHistory:
    ...
    def add_reply(self, text):
        pass
        # print("I don't store replies. I'm Eliza")
        # print(text)

class ElizaAgent(Agent):
    @classmethod
    def add_cmdline_args(
        cls, parser: ParlaiParser, partial_opt: Optional[Opt] = None
    ) -> ParlaiParser:
        group = parser.add_argument_group('Eliza Arguments')
        return parser
    ...
    def __init__(self, opt, shared=None):
        ...
        self.eliza.load(os.path.join(os.path.dirname(__file__), './doctor.txt'))
    ...
    def act(self):
        ...
        # print("OBS!!!! ^^^^^^^^^^^^^^^^")
        # print(obs['text'])
        resp_txt = self.eliza.respond(obs['text'])
